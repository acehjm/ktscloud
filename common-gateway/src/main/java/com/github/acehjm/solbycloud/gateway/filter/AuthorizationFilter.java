...
public class AuthorizationFilter {
    ...
    public GlobalFilter authGlobalFilter() {
        return (exchange, chain) -> {
            ...
            String url = String.format("http://%s/oauth/check_token?token=", "common-auth");
            ResponseEntity<Object> entity = restTemplate.getForEntity(url + tokenSplit[1], Object.class);
